	  ...
	  _createClass(Game, [{
	    ...
	    value: function checkCollisions() {
	      ...
	      this.sheep.forEach(function (sheep, idx, arr) {
	        if (_this2.leftCrook.collision(sheep) || _this2.rightCrook.collision(sheep)) {
	          sheep.clear(_this2.ctx);
	          arr.splice(idx, 1);
	          _this2.score += 1;
	        }
	      });
	    ...
	    value: function play() {
	      ...
	      this.sheep.forEach(function (sheep) {
	        sheep.clear(_this5.ctx);
	        sheep.move();
	        sheep.draw(_this5.ctx);
	        _this5.ctx.drawImage(_this5.grass, 0, 375);
	        _this5.ctx.font = "64px Helvetica Neue";
	        _this5.ctx.fillStyle = 'red';
	        _this5.ctx.fillText('' + _this5.score, 174, 490);
	        _this5.ctx.fillStyle = "rgb(0,218,246)";
	      });
	      if (this.fireLeft) {
