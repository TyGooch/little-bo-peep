	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function increaseVelocity(sheep) {
	      sheep.velocity.y += this.score * 0.5;
	    }
	  }, {
	    key: 'randomX',
	    ...
	    value: function play() {
	      ...
	      this.canvas.addEventListener('click', this.clickLeft, false);
	      this.canvas.addEventListener('click', this.clickRight, false);
	      if (!this.playing) {
	        this.canvas.removeEventListener('click', this.clickRight);
